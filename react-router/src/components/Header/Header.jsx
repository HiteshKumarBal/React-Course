        ...
        <header className='shadow sticky-z-50 top-0'>
            <nav className='bg-white border-gray-200 px-4 lg:px-6 py-2.5'>
                <div className='flex flex-wrap justify-between items-center mx-auto max-w-screen-xl'>
                    ...
                    <img src="https://dynamic.design.com/asset/logo/7d563d70-3746-4cdb-9914-120f4d72e441/logo-search-grid-1x?logoTemplateVersion=1&v=638741664547600000&text=portfolio+logo&layout=auto&colorpalette=purple" className='mr-3 h-12' alt="Logo" />
                    </Link>
